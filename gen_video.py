...
import pickle
from utils import combined_thresh
...
def annotate_image(img_in):
    ...
    img, abs_bin, mag_bin, dir_bin, imgThres_yellow, imgThres_white = combined_thresh(undist)
...
if __name__ == '__main__':
    # Annotate the video
    annotate_video('project_video.mp4', 'annotated_output.mp4')
