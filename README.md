...
#### Radius of Curvature
The equation of calculating the radius is here (). We have to convert from pixel space to meters (aka real world units) by defining the appropriate pixel height to lane length and pixel width to lane width ratios:
